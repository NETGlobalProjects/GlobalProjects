<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="facturacion.aspx.vb" Inherits="webadmintools.facturacion" MasterPageFile ="~/principal.Master"  %>
               ...
               <table style ="width :95%; text-align :left ;" cellspacing="0" cellpadding="0">
                   ...
                   <tr>
                       <td style ="border-top-left-radius:10px; border-top-right-radius : 10px;">
                           <br />
                           <dx:ASPxButton ID="cambioestatustiketsASPxButton1" runat="server" Text="CAMBIAR ESTATUS TIKETS P/REIMPRIMIR" Width ="100%" Theme="SoftOrange" Height ="40px" CssClass ="botonincialmenu "></dx:ASPxButton>
                       </td>
                   </tr>
