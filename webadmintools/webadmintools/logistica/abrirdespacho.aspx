<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="abrirdespacho.aspx.vb" Inherits="webadmintools.Formulario_web1" %>
<%@ Register Assembly="DevExpress.Web.v14.2, Version=14.2.3.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>ABRIR DESPACHO</h2>
       ...
       <%-- <Triggers >
        ...
        <tr><td>
            <dx:ASPxComboBox ID="sucursalASPxComboBox1" runat="server" ValueType="System.String" Width ="100%" Height ="35px" Theme="SoftOrange" ></dx:ASPxComboBox>
                    ...
                    <tr>
                        <td style ="text-align :left ; font-size : 14px; font :bold ;">Despacho No.</td>

                    </tr>
                   <tr>
                       <td> <dx:ASPxTextBox ID="despachoASPxTextBox1" runat="server" Width="100%" Height ="35px" Theme ="SoftOrange"></dx:ASPxTextBox></td>
                   </tr>
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical" Width ="100%" AutoGenerateColumns="False">
                                ...
                                <Columns>
                                    <asp:BoundField DataField="DespachoNo" HeaderText="Despacho No">
                           ...
                           <table style ="width :100%">
                               <tr>
                                   ...
                                   <td style ="text-align :left ;" colspan ="4">
                                       <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Motivo de apertura" Width ="150px"></dx:ASPxLabel>
                                   </td>
                                       </tr><tr>
                                   <td style ="width :100%" colspan ="4">
                                       <dx:ASPxTextBox ID="motivoASPxTextBox1" runat="server" Width="100%" Height ="35px" Theme ="SoftOrange" Enabled="False"></dx:ASPxTextBox>
                                   </td>
                                       </tr>
                               </tr>
                           </table>
