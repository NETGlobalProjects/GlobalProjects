<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="anulardespacho.aspx.vb" Inherits="webadmintools.anulardespacho" %>
       ...
       <%-- <Triggers >
        ...
        <tr><td>
            <dx:ASPxComboBox ID="sucursalASPxComboBox1" runat="server" ValueType="System.String" Width ="100%" Height ="35px" Theme="SoftOrange" ></dx:ASPxComboBox>
                   ...
                   <tr>
                       <td> <dx:ASPxTextBox ID="despachoASPxTextBox1" runat="server" Width="100%" Height ="35px" Theme ="SoftOrange" AutoPostBack="True"></dx:ASPxTextBox></td>
                   </tr>
