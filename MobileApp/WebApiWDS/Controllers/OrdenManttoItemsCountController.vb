...
Public Class OrdenManttoItemsCountController
...
#Enable Warning BC30002 ' No está definido el tipo 'GlobalDBEntities'.
    ...
    Public Function GetValue(ByVal id As String) As HttpResponseMessage
        ...
        Try
            ...
            maximo = (From c In ctx.mantto_orden_items
                      Where c.pai_id = p_pai_id And c.emp_id = p_emp_id And c.ord_id = p_ord_id
                      Select c.dor_id).Max()
            If (maximo > 0) Then
                Return Request.CreateResponse(HttpStatusCode.OK, maximo)
            Else
