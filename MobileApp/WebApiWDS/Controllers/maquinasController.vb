...
#Enable Warning BC30002 ' No está definido el tipo 'GlobalDBEntities'.
    ...
    Public Function GetValue(ByVal id As String) As HttpResponseMessage
        ...
        Dim p_pai_id As Integer, p_emp_id As Integer, p_are_id As Integer, p_sba_id As Integer
        ...
        Dim datos = (From m In ctx.activos_maquinas
                     Where m.pai_id = p_pai_id And m.emp_id = p_emp_id And m.are_id = p_are_id And m.sba_id = p_sba_id
